...
<html lang="es_mx">
    ...
    <body>
        <div class="Form inicio-sesion">
            ...
            <form class="Menu login-form" action="MenuPacientes?accion=Registrar" method="POST" autocomplete="off">
                <input type="submit" name="Resgistrar" value="Registrar" class="login-submit" />
            </form>
            <form class="Menu login-form" action="MenuPacientes?accion=Actualizar" method="POST" autocomplete="off">
                <input type="submit" name="Actualizar" value="Actualizar" class="login-submit" />
            </form>
            <form class="Menu login-form" action="MenuPacientes?accion=Eliminar" method="POST" autocomplete="off">
        ...
        <div id="popup1" class="<c:out value="${pop}"/> overlay">
            <div class="popup">
                ...
                <a class="close" href="MenuPacientes">&times;</a>
                <div class="content">
