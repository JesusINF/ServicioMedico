...
<html lang="es_mx">
    ...
    <body>
        <div class="Form inicio-sesion">
            <h1>Menú Vacaciones</h1>
            <form class="Menu login-form" action="MenuVacaciones?accion=Registrar" method="POST" autocomplete="off">
                <input type="submit" name="Resgistrar" value="Registrar" class="login-submit" />
            </form>
            <form class="Menu login-form" action="MenuVacaciones?accion=Eliminar" method="POST" autocomplete="off">
        ...
        <div id="popup1" class="<c:out value="${pop}"/> overlay">
            <div class="popup">
                ...
                <a class="close" href="MenuVacaciones">&times;</a>
                <div class="content">
