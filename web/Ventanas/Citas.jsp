...
<html lang="es_mx">
    ...
    <body>
        <div class="Form inicio-sesion">
            <h1>Menú Citas</h1>
            <form class="Menu login-form" action="MenuCitas?accion=Registrar" method="POST" autocomplete="off">
                <input type="submit" name="Resgistrar" value="Registrar" class="login-submit" />
            </form>
            <form class="Menu login-form" action="MenuCitas?accion=Actualizar" method="POST" autocomplete="off">
                <input type="submit" name="Actualizar" value="Actualizar" class="login-submit" />
            </form>
            <form class="Menu login-form" action="MenuCitas?accion=Eliminar" method="POST" autocomplete="off">
        ...
        <div id="popup1" class="<c:out value="${pop}"/> overlay">
            <div class="popup">
                ...
                <a class="close" href="MenuCitas">&times;</a>
                <div class="content">
